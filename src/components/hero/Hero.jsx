      ...
      <div className='hSection left'>
        ...
        <motion.div variants={awardVariants} initial="initial" animate="animate" className='awards'>
          ...
          <motion.div variants={awardVariants} className='awardList'>
            <motion.img variants={awardVariants} src='./award1.png' alt=''></motion.img>
            <motion.img variants={awardVariants} src='./award2.png' alt=''></motion.img>
            <motion.img variants={awardVariants} src='./award3.png' alt=''></motion.img>
          </motion.div>
        </motion.div>
        {/* 按钮 */}
        ...
        >
          ...
          transition={{duration:10, repeat:Infinity, ease:"linear"}}>
            <svg viewBox="0 0 200 200" width="150" height="150">
              <circle cx="100" cy="100" r="90" fill="#dd4c50"></circle>
              <path
                id="innerCirclePath"
                fill="none"
              ...
              <text className='circleText'>
                <textPath href="#innerCirclePath" >不错！</textPath>
              </text>
              <text className='circleText'>
                <textPath href="#innerCirclePath" startOffset="40%">联系我~</textPath>
              </text>
            </svg>
            <div className='arrow'>
              <svg
